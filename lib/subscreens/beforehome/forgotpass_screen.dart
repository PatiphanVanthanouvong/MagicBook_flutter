                  ...
                  child: Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            child: Text(
                              " ລິ້ງສໍາລັບການຕັ້ງລະຫັດຜ່ານໃໝ່ຈະຖືກສົ່ງໄປຍັງອີເມວທີ່ທ່ານກອກດ້ານເທິງກະລຸນາເຂົ້າໄປໃນອີເມວຂອງທ່ານເພື່ອເປີດລິ້ງແລະເຮັດການຕັ້ງລະຫັດຜ່ານໃໝ່",
                              style: TextStyle(
                                fontSize: 14,
                              ),
                          ...
                          AnimatedButton(
                            ...
                            pressEvent: () {
                              AwesomeDialog(
                                ...
                                showCloseIcon: true,
                                title: 'ສົ່ງຄໍາຂໍສໍາເລັດ',
                                desc: 'ທ່ານຈະໄດ້ຮັບອີເມວເພື່ອຢຶນຢັນການກູ້ຄືນ',
                                btnOkOnPress: () {
                                  debugPrint('OnClcik');
                                },
